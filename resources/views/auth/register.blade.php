            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center mb-5">
                        ...
                        <h3>Đăng ký</h3>
                        <p>Đăng ký tài khoản cabin tại HocLaiOto.net</p>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-6 mt-2 offset-sm-4 text-center">
                                <a class="mb-2" target="_blank" href="{{ route('login') }}"><i data-feather="Đăng nhập"></i> Đăng nhập</a>
                            </div>
                        </div>
                    </form>
                </div>
